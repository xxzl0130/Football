...
LSM303::LSM303(void)
{
    ...
    */
    offset = (LSM303::vector<int16_t>){0, 0, 0};
...
//set offset for magnetometer
void LSM303::setOffset(int16_t xoffset = 0,int16_t yoffset = 0,int16_t zoffset = 0)
{
    offset = (LSM303::vector<int16_t>)
    {
